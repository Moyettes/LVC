...
import com.moyettes.legacyvoicechat.gui.GroupsScreen;
import com.moyettes.legacyvoicechat.gui.GroupMembersScreen;
...
public class Voice implements ModInitializer {
	...
	// No PacketByteBuf at this MC era — OSL's CustomPayload uses
	// DataInputStream/DataOutputStream directly, which matches common's
	// CustomPayload interface. Declare both interfaces and let one set of
	// read/write methods satisfy both.
