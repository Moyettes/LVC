...
public class RenderEvents {
	...
	public RenderEvents() {
		...
		ClientEvents.INSTANCE.registerRenderPlayerIconsEvent((networkId, d, e, f) -> {
			// client-common's callback is loader-agnostic (int networkId);
			// resolve back to this build's PlayerEntity so we have the full
			// entity state (isSneaking etc.) for the render transform.
