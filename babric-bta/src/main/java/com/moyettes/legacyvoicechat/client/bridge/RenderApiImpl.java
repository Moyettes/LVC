...
public final class RenderApiImpl implements IRenderApi {
	...
	public void drawCenteredString(String text, int centerX, int y, int color) {
		...
		if (font != null) {
			...
			font.drawStringWithShadow(text, centerX - w / 2, y, color);
		}
	}
	...
	public int textWidth(String text) {
		Font font = font();
		return font != null ? font.getStringWidth(text) : text.length() * 6;
	}
	...
	public void bindTexture(ResourceLike texture) {
		...
		Texture tex = mc.textureManager.loadTexture(path);
