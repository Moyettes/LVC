...
// into the RawRetroMCP drop-in so client-common's pre-compiled
// INVOKEINTERFACE bytecode resolves at runtime. Must include the specific
// positional overloads (1/2/3/4 args, Throwable) because call sites compile
// against the concrete log4j method signatures, not the vararg collapse.
